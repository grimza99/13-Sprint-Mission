...
export default function Nav() {
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-[70px] bg-white px-[10px] py-[200px] md:px-[24px] md:py-[10px]  sm:px-[15px] sm:py-[15px] z-50">
      <div className="flex justify-between w-screen max-w-full ">
        <div className="flex items-center w-screen gap-8 sm:gap-2">
          <div className="flex w-auto gap-2">
            ...
            />
            <Image
              className="w-[103px] h-[51px] cursor-pointer sm:w-20"
              src={textLogo}
              alt="판다마켓"
              width={103}
              height={51}
          ...
          <div className="flex w-auto gap-7 sm:gap-2">
